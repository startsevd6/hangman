...
def play(word):
    ...
    while True:
        ...
        if not word_input.isalpha():
            print('Вы должны были ввести букву или слово целиком, попробуйте ещё раз')
            continue
        ...
        if word_input in guessed_words:
            print('Вы уже вводили это слово, попробуйте ещё раз')
            continue
...
play(get_word())
while True:
    continue_input = input('Хотите сыграть ещё раз (да/нет): ').lower()
    if continue_input.startswith('д'):
        play(get_word())
    elif continue_input.startswith('н'):
        print('Ещё увидимся!')
        break
    else:
        print('Вы должны были ввести да либо нет, попробуйте ещё раз')
